                ...
                <section class="content-header">
                    <h1>
                        ...
                        <small>Tours List</small>
                         <a href="<?php echo site_url()."administrator/tours/add_tour/"; ?>" class="btn btn-app">
                                        <i class="fa fa-edit"></i> Add tour
                                    </a>
                    ...
                    <ol class="breadcrumb">
                      <li><a href="<?php echo site_url('administrator/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Tours/Add tours</a></li>
				    ...
				    ?>      
																			<tr>
																						...
																						<ul class="dropdown-menu">
																							<li><a href="<?php echo site_url()."administrator/tours/edit_tour/".$row->id; ?>"> Edit</a></li>                                      
																							<li><a href="<?php echo site_url()."administrator/tours/delete_tour/".$row->id; ?>"> Delete</a></li>                   
																						</ul>
																						</div></td>
																			</tr>
