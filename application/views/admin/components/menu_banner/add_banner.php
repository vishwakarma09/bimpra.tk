		...
		<?php   } ?>
		  ...
		  <i class="fa fa-arrow-left"></i>&nbsp;&nbsp;
           Go Back (Banner List)
								 ...
								 <form action="<?php echo site_url('administrator/home/add_banner_submit_data');?>" method="POST" onsubmit="return sct_bhanu_validate_form()" enctype="multipart/form-data">
									  ...
									  <div class="col-md-6">
									    <div class="form-group">
										   ...
										   <select name="sub_category" class="form-control">
										        <option value="main_home_banner">Main Home Banner</option>
										   </select>
                                        </div>
										</div>
										<div class="col-md-6">
									...
									<div class="form-group">
                                           ...
                                           <textarea name="banner_text"  style="width:100%"></textarea>
                                    </div>
									</div>
									</div>
									<div class="col-md-12">
