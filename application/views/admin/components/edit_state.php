                                ...
                                <div class="box-header">
                                    ...
                                    <div class="box-body">
																				...
																				<div class="form-group">
																					...
																					<input type="text" name="display_name" id="display_name" value="<?php echo $data->display_name;?>" class="form-control" />
																				</div>
																				...
																				<div class="form-group">
																					<label for="type">Select option</label>
																						<select id="type" name="type" class="form-control">
																							...
																							<option value="Domestic" <?php if($data->type == "Domestic") echo "selected";?>>Domestic</option>
																							<option value="International" <?php if($data->type == "International") echo "selected";?>>International</option>
																						</select>
																				</div>
