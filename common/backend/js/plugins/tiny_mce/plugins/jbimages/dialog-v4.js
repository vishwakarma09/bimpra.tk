...
var jbImagesDialog = {
	...
	uploadFinish : function(result) {
		...
		else
		{
			...
			tinymce.EditorManager.activeEditor.insertContent('<img src="http://localhost/bimpra_ci' + result.filename +'">');
			tinymce.EditorManager.activeEditor.insertContent('<br/>hello world</br>');
